...
internal static class TestHelpers
{
    ...
    public static string RunVoicings(string chord, string tuning = "STANDARD", int limit = 5, bool pretty = true,
        SearchParams? searchParams = null, double minComfort = 0.0) =>
        RunToString(env => VoicingsCommand.Run(env, chord, tuning, searchParams ?? SearchParams.Default, limit,
            minComfort: minComfort), pretty);
